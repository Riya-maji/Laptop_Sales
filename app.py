...
# Load data
df = pd.read_csv("Cleaned_data (1).csv")  # Replace with the actual path if running locally
...
# # Save the Streamlit code to a .py file for easy deployment
# streamlit_code_path = 'app.py'
